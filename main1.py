...
h_size = windows_normal.shape[1] * hidden_size  # window_size * hidden_size
z_size = windows_normal.shape[1] * latent_size  # window_size * latent_size
...
model = VAEUSADModel(w_size, h_size, z_size)
